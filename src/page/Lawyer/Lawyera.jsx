...
const sampleData = [
    {
        ...
        challengeName: "2mint Burger Challenge",
        challengeScore: 20,
        coins: 20,
        time: "2 Day 2 Hour 5min",
        description: "Just ......",
        imageUrl: "https://randomuser.me/api/portraits/women/44.jpg",
        videoThumbnail: "https://picsum.photos/100/60", // Replace with real thumbnail
    },
    // Repeat for demo
    {
        id: 2,
        ...
        description: "Just ......",
        imageUrl: "https://randomuser.me/api/portraits/women/44.jpg",
        videoThumbnail: "https://picsum.photos/100/60",
    },
    {
        id: 3,
        name: "Afsana hamid mim",
            ...
            {paginatedData.map((item) => (
                ...
                >
                    ...
                    <div className="flex flex-col items-center ml-6">
                        ...
                        />
                        <Link to={`/challenges/${item.id}`} className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-8 rounded" >
                            View Details
                        </Link>
                    </div>
                </div>
